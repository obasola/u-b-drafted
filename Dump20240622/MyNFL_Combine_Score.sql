...
--
-- Table structure for table `Combine_Score`
--

DROP TABLE IF EXISTS `Combine_Score`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `Combine_Score` (
...
--
-- Dumping data for table `Combine_Score`
--

LOCK TABLES `Combine_Score` WRITE;
/*!40000 ALTER TABLE `Combine_Score` DISABLE KEYS */;
/*!40000 ALTER TABLE `Combine_Score` ENABLE KEYS */;
UNLOCK TABLES;
